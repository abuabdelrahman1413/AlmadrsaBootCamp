...
class TwoStacks {
    ...
    public Integer pop1() throws EmptyStackException {
		...
		int newSize = top1-1;
		int elementToPop = stacksStore[newSize];
		stacksStore[newSize] = null;
		top1 = newSize;
        return elementToPop;
    }
